...
public class VersionMessage extends Message {
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for floj
     * users might look like "/floj:0.13/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/floj:1.0/MultiBit:1.0(Windows)/". Therefore the / ( and ) characters are reserved in all these
