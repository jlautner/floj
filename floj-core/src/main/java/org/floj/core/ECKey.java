...
public class ECKey implements EncryptableItem {
     ...
     * determine if the signature was correct. These sorts of signatures are compatible with the FLO-Qt/flod
     ...
     * flos controlled by the private key) you can use this method to check when you *encrypt* a wallet that
